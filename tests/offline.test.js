...
const CORRECT_RUNTIME_FILES=["LANDSCAPE","PORTRAIT","ULTRAWIDE"].map(format=>`assets/visual-6.36/references/LOS_CORRECT_6_36_${format}_RUNTIME.png`);
const WEST_COAST_RUNTIME_FILES=[
 "assets/west-coast/runtime/final-showdown-question/Final_Showdown_Landscape_CLEAN.png","assets/west-coast/runtime/final-showdown-question/Final_Showdown_Portrait_CLEAN.png","assets/west-coast/runtime/final-showdown-question/Final_Showdown_Ultrawide_CLEAN.png",
 "assets/west-coast/runtime/FINAL_SHOWDOWN_MATCHUP_LANDSCAPE_CLEAN.png","assets/west-coast/runtime/FINAL_SHOWDOWN_MATCHUP_PORTRAIT_CLEAN.png","assets/west-coast/runtime/FINAL_SHOWDOWN_MATCHUP_ULTRAWIDE_CLEAN.png",
 ...
 "assets/west-coast/runtime/Winner_Landscape_Runtime_REFINED.png","assets/west-coast/runtime/Winner_Portrait_Runtime_REFINED_V2.png","assets/west-coast/runtime/Winner_Ultrawide_Runtime_REFINED.png"
];
const REQUIRED_FILES=[
 "index.html","app.css","app.js","assets/visual-6.36/los-avatar-atlas-v2.png","assets/visual-6.36/los-avatar-style-expansion-v3.png","host-provider.js","service-worker-register.js","question-bank-data.js",
 ...
 "question-bank.js","manifest.webmanifest","apple-touch-icon.png","icon-192.png","icon-512.png",...CORRECT_RUNTIME_FILES,...WEST_COAST_RUNTIME_FILES
];
