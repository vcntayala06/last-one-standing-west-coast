...
const APPROVED_VISUAL_RUNTIME=APPROVED_VISUAL_SCREENS.filter(screen=>screen!=="HOME"&&screen!=="FINAL_SHOWDOWN_QUESTION").flatMap(screen=>["LANDSCAPE","PORTRAIT","ULTRAWIDE"].map(format=>`assets/visual-6.36/references/LOS_${screen}_6_36_${format}_RUNTIME.png`));
...
const WEST_COAST_CURRENT_STANDINGS=["LANDSCAPE","PORTRAIT","ULTRAWIDE"].flatMap(format=>[`assets/west-coast/runtime/LOS_CURRENT_STANDINGS_${format}_CLEAN.png`,`assets/west-coast/runtime/LOS_CURRENT_STANDINGS_${format}_NO_LOGO.png`,...format==="ULTRAWIDE"?[`assets/west-coast/runtime/LOS_CURRENT_STANDINGS_${format}_RUNTIME_LOCKED.png`]:[]]);
...
const WEST_COAST_ELIMINATED=["LANDSCAPE","PORTRAIT","ULTRAWIDE"].flatMap(format=>[`assets/west-coast/runtime/LOS_ELIMINATED_${format}_CLEAN.png`,`assets/west-coast/runtime/LOS_ELIMINATED_${format}_NO_LOGO.png`,`assets/west-coast/runtime/LOS_ELIMINATED_${format}_NO_LOGO_NO_CIRCLE.png`]);
const WEST_COAST_WINNER=["LANDSCAPE","PORTRAIT","ULTRAWIDE"].map(format=>`assets/west-coast/runtime/LOS_WINNER_6_36_${format}_NO_CAPSULE.png`);
const WEST_COAST_WINNER_LOCKED=["assets/west-coast/runtime/Winner_Landscape_Runtime_REFINED.png","assets/west-coast/runtime/Winner_Portrait_Runtime_REFINED_V2.png","assets/west-coast/runtime/Winner_Ultrawide_Runtime_REFINED.png"];
const PUBLIC_FILES=new Set(["index.html","app.js","app.css","assets/visual-6.36/los-home-hero.png",...APPROVED_VISUAL_REFERENCES,...APPROVED_VISUAL_RUNTIME,...WEST_COAST_CHOOSE_GAME,...WEST_COAST_HOME,...WEST_COAST_FINAL_QUESTION,...WEST_COAST_CURRENT_STANDINGS,...WEST_COAST_TIMES_UP,...WEST_COAST_PASS_SKIP,...WEST_COAST_ELIMINATED,...WEST_COAST_WINNER,...WEST_COAST_WINNER_LOCKED,"assets/visual-6.36/los-avatar-atlas-v2.png","assets/visual-6.36/los-avatar-style-expansion-v3.png","host-provider.js","question-bank-data.js","question-bank-batch-1.js","question-bank-batch-2.js","question-bank-batch-3.js","question-bank-batch-4.js","question-bank-batch-5.js","question-bank-batch-6.js","question-bank-batch-7.js","question-bank-batch-8.js","question-bank-batch-9.js","question-bank-batch-10.js","question-bank.js","manifest.webmanifest","apple-touch-icon.png","icon-192.png","icon-512.png","service-worker.js","service-worker-register.js"]);
